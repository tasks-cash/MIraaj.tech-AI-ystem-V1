      ...
      <div className="mx-auto max-w-7xl">
        ...
        <details className="mt-12 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <form action={createCampaignTask} className="mt-6 grid gap-4 md:grid-cols-2">
            ...
            <fieldset className="grid gap-3 rounded-xl border border-slate-200 p-4 md:col-span-2"><legend className="px-2 font-bold">Recurring schedule</legend>
              <label className="flex gap-2"><input type="checkbox" name="recurrenceEnabled" /> Enable recurrence</label>
              <div className="grid gap-3 md:grid-cols-3"><select name="recurrenceCadence" className="rounded-lg border p-2"><option value="">Frequency</option><option value="daily">Daily</option><option value="weekly">Weekly</option></select><input name="recurrenceInterval" type="number" min="1" max="52" defaultValue="1" aria-label="Recurrence interval" className="rounded-lg border p-2" /><input name="recurrenceWeekdays" placeholder="Weekdays: 0,1,2" className="rounded-lg border p-2" /><input name="recurrenceLocalTime" type="time" defaultValue="09:00" className="rounded-lg border p-2" /><input name="recurrenceTimezone" defaultValue="Africa/Algiers" placeholder="Timezone" className="rounded-lg border p-2" /><input name="recurrenceMaxOccurrences" type="number" min="1" max="365" placeholder="Maximum occurrences" className="rounded-lg border p-2" /><input name="recurrenceStartDate" type="date" className="rounded-lg border p-2" /><input name="recurrenceEndDate" type="date" className="rounded-lg border p-2" /><label className="flex items-center gap-2"><input type="checkbox" name="allowParticipantRepeat" defaultChecked /> Allow repeat participants</label></div>
            </fieldset>
