...
- Result checksum: SHA-256 of canonical UTF-8 JSON `{decision,reasons,scores}`, with recursively sorted object keys and sorted unique reason codes; array order is otherwise preserved.
