...
export const AI_PERMISSIONS = {
  ...
  DISTRIBUTION_OPERATIONS_READ: "ai.distributionOperations.read",
  DISTRIBUTION_OPERATIONS_MANAGE: "ai.distributionOperations.manage",
  CAMPAIGN_TASKS_READ: "aiCampaignTasks.read",
  CAMPAIGN_TASKS_CREATE: "aiCampaignTasks.create",
  CAMPAIGN_TASKS_UPDATE: "aiCampaignTasks.update",
  CAMPAIGN_TASKS_APPROVE: "aiCampaignTasks.approve",
  CAMPAIGN_TASKS_ACTIVATE: "aiCampaignTasks.activate",
  CAMPAIGN_TASKS_PAUSE: "aiCampaignTasks.pause",
  CAMPAIGN_TASKS_CANCEL: "aiCampaignTasks.cancel",
  CAMPAIGN_TASKS_ARCHIVE: "aiCampaignTasks.archive",
  CAMPAIGN_TASKS_INVITE: "aiCampaignTasks.invite",
  CAMPAIGN_TASKS_ASSIGN: "aiCampaignTasks.assign",
  CAMPAIGN_TASKS_STATISTICS_READ: "aiCampaignTasks.statistics.read",
  CAMPAIGN_TASKS_PROOFS_READ: "aiCampaignTasks.proofs.read",
  CAMPAIGN_TASKS_PROOFS_REVIEW: "aiCampaignTasks.proofs.review",
  CAMPAIGN_TASKS_PROOFS_REQUEST_EVIDENCE: "aiCampaignTasks.proofs.requestEvidence",
  CAMPAIGN_TASKS_RECONCILIATION_RUN: "aiCampaignTasks.reconciliation.run",
} as const;
...
export const apiEnvironmentSchema = serverEnvironmentSchema
  .extend({
    ...
    DISTRIBUTION_DUPLICATE_PROOF_RETENTION_DAYS: positiveInt(1, 730).default(60),
    DISTRIBUTION_FRAUD_PROOF_RETENTION_DAYS: positiveInt(1, 3_650).default(180),
    DISTRIBUTION_GENERATED_ASSET_RETENTION_DAYS: positiveInt(1, 365).default(30),
    ...
    DISTRIBUTION_HUMAN_REVIEW_ENABLED: environmentBoolean.default(true),
    DISTRIBUTION_HISTORICAL_METRICS_ENABLED: environmentBoolean.default(true),
    DISTRIBUTION_PILOT_ENABLED: environmentBoolean.default(false),
    DISTRIBUTION_PILOT_CAMPAIGN_ALLOWLIST: z.string().default(""),
    DISTRIBUTION_PILOT_MAX_ACTIVE_ASSIGNMENTS: positiveInt(0, 100_000).default(0),
    DISTRIBUTION_PILOT_MAX_ASSIGNMENTS_PER_EXTERNAL_TASK: positiveInt(0, 10_000).default(0),
    DISTRIBUTION_PILOT_MAX_ASSIGNMENTS_PER_EXTERNAL_USER: positiveInt(0, 1_000).default(0),
    DISTRIBUTION_PILOT_ALLOWED_COUNTRIES: z.string().default(""),
    DISTRIBUTION_PILOT_ALLOWED_LANGUAGES: z.string().default(""),
    DISTRIBUTION_PILOT_ALLOWED_PLATFORMS: z.string().default(""),
    DISTRIBUTION_EMERGENCY_ASSIGNMENT_STOP: environmentBoolean.default(false),
    DISTRIBUTION_EMERGENCY_PROOF_STOP: environmentBoolean.default(false),
